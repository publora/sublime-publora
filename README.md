...
Select the text, run one command, and it goes out. This package sends the selection, or the whole file, to [Publora](https://publora.com) as a scheduled post or a draft.
...
3. Open [Settings → API keys](https://app.publora.com/dashboard/api) and press Generate API key.
